...
export const Products = () => {
    ...
    const options = {
        ...
        headers: {
            ...
            'x-rapidapi-key':
                'acd3cddf76msh4ff9c5ffffbd79ep166ba1jsnc4e897cc2183',
        },
    };
    ...
    const handleOrder = (product, price) => {
        console.log(price);
        setProductsCard([...productsCard, [product, price]]);
    };
                            ...
                            return (
                                <div className="col" key={index + 1}>
                                    <div className="card div-card">
                                        <img
                                            src={burgerTopCard}
                                            className="card-img-top burger-card-top"
                                            alt="..."
                                        />
                                        <div className="card-body mx-auto">
                                            ...
                                            <button
                                                ...
                                                data-neworder={item.name}
                                                onClick={() =>
                                                    handleOrder(item.name, (item.id <= 20
                                                        ? item.id + 10
                                                        : item.id - 2))
                                                }
                                            >
